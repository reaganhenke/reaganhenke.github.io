...
Builds and deploys the app with Github Pages. Note that the master branch is what's actually being served, so all dev work should be kept on the source branch.
